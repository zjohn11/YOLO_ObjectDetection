...
label = tk.Label(root, text="Select a .mp4 video to annotate with YOLO",
                 bg="#FE5C00", fg="white", font=("Helvetica", 12))
label.pack(pady=20)

btn = tk.Button(root, text="Choose Video", command=open_file,
